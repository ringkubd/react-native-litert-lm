...
export const BUILTIN_MODELS: LiteRTLMModelInfo[] = [
  {
    name: 'Gemma 2 2B',
    id: 'gemma-2-2b',
    url: 'https://www.kaggle.com/models/google/gemma-2/tfLite/gemma2-2b-it-gpu-task',
  ...
  },
  {
    name: 'Gemma 2 2B (CPU)',
    id: 'gemma-2-2b-cpu',
    url: 'https://www.kaggle.com/models/google/gemma-2/tfLite/gemma2-2b-it-cpu-task',
    sizeBytes: 1_400_000_000,
    maxTokens: 2048,
    backend: 'cpu',
    description: 'Same model, CPU-optimized. Works on 4GB+ devices.',
  },
  {
    name: 'Gemma 2 2B (NPU)',
    id: 'gemma-2-2b-npu',
    url: 'https://www.kaggle.com/models/google/gemma-2/tfLite/gemma2-2b-it-npu-task',
    sizeBytes: 1_600_000_000,
    maxTokens: 4096,
    backend: 'npu',
    description: 'NPU-optimized for Snapdragon 8 Gen 3+ devices.',
  },
  {
    name: 'Gemma 2 2B (Q4)',
    id: 'gemma-2-2b-q4',
    url: 'https://www.kaggle.com/models/google/gemma-2/tfLite/gemma2-2b-it-q4-task',
    sizeBytes: 900_000_000,
    maxTokens: 2048,
    backend: 'auto',
    description: '4-bit quantized. Smallest, fastest. Works on 3GB+ devices.',
  },
];
